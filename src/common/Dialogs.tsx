...
type ForgetPasswordModalPropType = {
  title: string, yesText: string, onNoClick: () => void,
  onYesClick: (email:string) => void, modelVisible: boolean, setEmail: any, email: string,
...
export const ForgotPasswordModal = (props: ForgetPasswordModalPropType) => {
  const { title, yesText, onNoClick,
    onYesClick, modelVisible, setEmail, email,
    emailError, setFogotPasswordEmailError } = props
  return (
    <Modal visible={modelVisible} transparent animationType={'slide'} >
      <TouchableOpacity onPress={() => { onNoClick() }} >
        <View style={stylesModal.modalView}>
